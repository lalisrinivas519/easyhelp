         ...
         <div class="container largeContainer">
            <div class="row">
               <div class="col-md-12 text-center">
                  ...
                  <p class="breadcrumbs"><a href="index.php" rel="v:url">Home</a> /Register</p>
               </div>
            </div>
         </div>
      </section><br><br>
	  <section class="organia_full_width_page">
         ...
         <div style="width:420px; background: ; color:white; position:relative; border-radius:20px; padding:30px 40px;">
            <form action="register_process.php" method="POST">
               <h1 style="font-size:34px; color:#f06930;" >Register Here!</h1>
			
			    
               <div  style="width:100%; height:50px; margin:30px 0;" >
                  <input type="text" placeholder="Enter Sponser Id" name="userid" required style="width:110%; height:100%; background:#edbb5c; border:none; outline:none; border: 2px solid rgba(255,255,255,.2); border-radius:40px; padding:20px 45px 20px 20px;  " >
                  <i class='bx bx-user' style="position:absolute; right:55px; top:27%; transform:translateY(-50%); font-size:20px; color:black;"></i>
               </div>
               <div  style="width:100%; height:50px; margin:30px 0;" >
                  <input type="text" placeholder="Enter Name" name="name" required style="width:110%; height:100%; background:#edbb5c; border:none; outline:none; border: 2px solid rgba(255,255,255,.2); border-radius:40px; padding:20px 45px 20px 20px;  " >
                  <i class='bx bx-user' style="position:absolute; right:55px; top:27%; transform:translateY(-50%); font-size:20px; color:black;"></i>
               </div>
               <div  style="width:100%; height:50px; margin:30px 0;" >
                  <input type="email" placeholder="Enter Email Address" name="email" required style="width:110%; height:100%; background:#edbb5c; border:none; outline:none; border: 2px solid rgba(255,255,255,.2); border-radius:40px; padding:20px 45px 20px 20px;  " >
                  <i class='bx bx-user' style="position:absolute; right:55px; top:27%; transform:translateY(-50%); font-size:20px; color:black;"></i>
               </div>
               <div  style="width:100%; height:50px; margin:30px 0;" >
                  <input type="text" placeholder="Enter Phone Number" name="mobile" required style="width:110%; height:100%; background:#edbb5c; border:none; outline:none; border: 2px solid rgba(255,255,255,.2); border-radius:40px; padding:20px 45px 20px 20px;  " >
                  <i class='bx bx-user' style="position:absolute; right:55px; top:27%; transform:translateY(-50%); font-size:20px; color:black;"></i>
               </div>
               <div style="width:100%; height:50px; margin:30px 0;">
               ...
               <div style="width:100%; height:50px; margin:30px 0;">
                  <input type="password" placeholder="Enter Confirm Password" name="confirm_password" required style="width:110%; height:100%; background:#edbb5c; border:none; outline:none; border: 2px solid rgba(255,255,255,.2); border-radius:40px; padding:20px 45px 20px 20px;" >
                  <i class='bx bx-lock-alt'  style="position:absolute; right:55px; top:47%; transform:translateY(-50%); font-size:20px; color:black;" ></i>
               </div>
