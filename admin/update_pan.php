                                          ...
                                          <div class="card">
                                             ...
                                             <div class="card-block">
                                                <?php
                                                   ...
                                                   ?>
                                                <form method="POST" action="upload_pan.php" enctype="multipart/form-data">
                                                   <input type="hidden" name="userid" value="<?php echo $userid?>">
                                                   <div class="form-group">
                                                      <label for="pan_no">Pan No: </label>
                                                      <input type="number" name="pan_no" id="pan_no" class="form-control" placeholder="Enter Pan No"
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <?php
                                                             ...
                                                             ?>
                                                      <center> <img src="kyc/<?php echo $row['pan_image'];?>" style="border-radius:10px; width:300px;height:200px;"></center>
                                                      <?php
                                                         }
                                                         ?>
                                                   </div>
                                                   <div class="form-group">
                                                      ...
                                                      <input type="file" name="image" id="image" class="form-control" placeholder="Upload Pan Image"
                                                         data-parsley-trigger="change"
                                                         pattern=""
                                                         required>
                                                   </div>
                                                ...
                                                <?php
                                                   ...
                                                   $status='on';
                                                              ...
                                                              move_uploaded_file( $_FILES['image']['tmp_name'], $target);
                                                       	     if($query){
                                                       	          echo '<script>alert("UPDATE SUCCESSFUL.");window.location.assign("upload_pan.php");</script>';
                                                       	     }else{
                                                       	         echo '<script>alert("Something Went Wrong.");window.location.assign("upload_pan.php");</script>'; 
                                                       	     }
                                                       	     
                                                       	     }else{
                                                       	         echo '<script>alert("Please Field All The Field.");window.location.assign("upload_pan.php");</script>';
                                                       	     }   
                                                   }
                                                   ?>
                                             </div>
